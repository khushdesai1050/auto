...
// ✅ Popup Component (same as other forms)
...
export function HomeLoan({ title }: { title: string }) {
  ...
  // ✅ Preselect correct service if present in URL
  useEffect(() => {
  ...
  // ✅ Handle form submit with same API + popup logic
